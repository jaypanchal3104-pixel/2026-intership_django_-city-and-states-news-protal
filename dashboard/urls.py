...
urlpatterns = [
    ...
    path("advertiser/campaign/create/",          views.advertiserCampaignCreateView, name="advertiser_campaign_create"),
    path("advertiser/campaign/<int:pk>/edit/",   views.advertiserCampaignEditView,   name="advertiser_campaign_edit"),
    path("advertiser/campaign/<int:pk>/delete/", views.advertiserCampaignDeleteView, name="advertiser_campaign_delete"),
]